  ...
  return (
    ...
    <Container>
      ...
      <form noValidate onSubmit={handleSubmit(onSubmit)} id="pomodoro-form">
        <Input type="number" name="minutes" id="minutes-input" ref={register({
          required: {value: true, message: "Please enter the number of minutes that you would like to study for"},
          min: {value: .01,  message: "Please enter a number between 1 and 100"},
          max: {value: 100,  message: "Please enter number between 1 and 100"},
        })}
        />
